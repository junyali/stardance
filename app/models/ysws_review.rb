...
# Indexes
#
#  index_ysws_reviews_on_post_ship_event_id  (post_ship_event_id)
#  index_ysws_reviews_on_project_id          (project_id)
#  index_ysws_reviews_on_reviewer_id         (reviewer_id)
#  index_ysws_reviews_on_ship_cert_id        (ship_cert_id)
#  index_ysws_reviews_on_spotchecked_by_id   (spotchecked_by_id)
#  index_ysws_reviews_on_user_id             (user_id)
#
# Foreign Keys
#
